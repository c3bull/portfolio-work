...
export default function Navbar() {
    ...
    return (
        <nav
            className={`${toggle && 'bg-secondary'} hover:bg-secondary hover:border-b-gray-600 w-full flex items-center h-24 fixed top-0 z-30 border-b-2 ${scrollTop >= 5 ? 'bg-secondary/100 border-b-gray-600' : 'border-b-transparent'} duration-300`}>
