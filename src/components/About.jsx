    ...
    return (
        <div className='text-white flex flex-col justify-center items-center bg-primary w-full'>
            ...
            <div className='relative'>
                ...
                <img src={aboutmeimg} alt="bgimg" className='relative w-full h-full top-0 left-0 opacity-30'/>
                <div className='absolute w-1/2 top-[20%] p-5 left-0 right-0 mx-auto text-xl'>
                    <Typed
